            ...
            <div className="lg:col-span-3 space-y-6 order-2 lg:order-1">
              ...
              <div className="pt-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  and Urban Digital Transformation. Currently pursuing a Doctorate in Digital Transformation in Urban
                  Governance, Om combines academic rigor with practical execution. He is known for leading high-impact
